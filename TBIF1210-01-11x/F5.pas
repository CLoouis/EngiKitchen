...
implementation
	procedure beliBahan(var tSimulasi : tabSimulasi; var tInventoriBahanMentah : tabInventoriBahanMentah; var tBahanMentah : tabBahanMentah;
		...
		var
			...
			totalHarga : longint; //total harga dari belanja. jika barang tidak ada di supermarket, maka harga menjadi 0
			...
			begin
				...
				if (totalHarga <= 0) then  
					begin
						writeln('Pembelian gagal, silahkan cek kembali nama barang dan kuantitas anda');
					end
