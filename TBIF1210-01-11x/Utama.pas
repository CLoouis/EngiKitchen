...
begin
	...
	begin
		...
		begin
			...
			writeln();
			menu := 'a'; //asal aja
			while ((menu <> 'stop simulasi') and (tSimulasi.tab[nomor_simulasi].JumlahHariHidup < 10)) do
				begin
				if (tSimulasi.tab[nomor_simulasi].JumlahEnergi > 0) then
				begin
				writeln('> Menu Utama');
				writeln();
